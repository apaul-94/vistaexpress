    ...
    <div class="container">
        <div class="row row-cols-1 p-3">
            ...
            <div class="col-md" id="hero-section-col2">
                <img class='w-100' src='<?php echo esc_url(get_template_directory_uri() . '/images/hero-section-image.png'); ?>' alt=''>
            </div>
    ...
    <div class="container">
        ...
        <div class="row row-cols-2">
            ...
            <div class="col-lg p-3">
                <div class="row">
                    <div class="col text-center" id="features-image">
                        <img class='w-50' src='<?php echo esc_url(get_template_directory_uri() . '/images/header.png'); ?>' alt=''>
            ...
            <div class="col-lg p-3">
                <div class="row">
                    <div class="col text-center" id="features-image">
                        <img class='w-50' src='<?php echo esc_url(get_template_directory_uri() . "/images/responsive.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row">
                    <div class="col text-center" id="features-texts">
            ...
            <div class="col-lg p-3">
                <div class="row">
                    <div class="col text-center" id="features-image">
                        <img class='w-50' src='<?php echo esc_url(get_template_directory_uri() . "/images/widget.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row">
                    <div class="col text-center" id="features-texts">
            ...
            <div class="col-lg p-3">
                <div class="row">
                    <div class="col text-center" id="features-image">
                        <img class='w-50' src='<?php echo esc_url(get_template_directory_uri() . "/images/navigation.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row">
                    <div class="col text-center" id="features-texts">
            ...
            <div class="col-lg p-3">
                <div class="row">
                    <div class="col text-center" id="features-image">
                        <img class='w-50' src='<?php echo esc_url(get_template_directory_uri() . "/images/post-display.png"); ?>' alt=''>
            ...
            <div class="col-lg p-3">
                <div class="row">
                    <div class="col text-center" id="features-image">
                        <img class='w-50' src='<?php echo esc_url(get_template_directory_uri() . "/images/updates.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row">
                    <div class="col text-center" id="features-texts">
    ...
    <div class="container">
        <div class="row row-cols-1 p-3">
            ...
            <div class="col-lg" id="admin-section-col1">
                <img class='w-100' src='<?php echo esc_url(get_template_directory_uri() . "/images/admin-section-image.png"); ?>' alt=''>
            </div>
    ...
    <div class="container">
        ...
        <div class="row row-cols-1">
            ...
            <div class="col-md p-3" id="tools-tech-col">
                <div class="row">
                    <div class="col" id="tools-tech-image">
                        <img class='w-25' src='<?php echo esc_url(get_template_directory_uri() . "/images/wordpress-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="col-md p-3" id="tools-tech-col">
                <div class="row">
                    <div class="col" id="tools-tech-image">
                        <img class='w-25' src='<?php echo esc_url(get_template_directory_uri() . "/images/php-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row">
                    <div class="col" id="tools-tech-text1">
            ...
            <div class="col-md p-3" id="tools-tech-col">
                <div class="row">
                    <div class="col" id="tools-tech-image">
                        <img class='w-25' src='<?php echo esc_url(get_template_directory_uri() . "/images/bootstrap-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row">
                    <div class="col" id="tools-tech-text1">
            ...
            <div class="col-md p-3" id="tools-tech-col">
                <div class="row">
                    <div class="col" id="tools-tech-image">
                        <img class='w-25' src='<?php echo esc_url(get_template_directory_uri() . "/images/vscode-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row">
                    <div class="col" id="tools-tech-text1">
        ...
        <div class="row row-cols-2">
            ...
            <div class="col-lg">
                <div class="row">
                    <div class="col text-center" id="other-tools-tech-image">
                        <img class='w-100' src='<?php echo esc_url(get_template_directory_uri() . "/images/html-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row pb-2">
            ...
            <div class="col-lg">
                <div class="row">
                    <div class="col text-center" id="other-tools-tech-image">
                        <img class='w-100' src='<?php echo esc_url(get_template_directory_uri() . "/images/css-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row pb-2">
                    <div class="col text-center">
            ...
            <div class="col-lg">
                <div class="row">
                    <div class="col text-center" id="other-tools-tech-image">
                        <img class='w-100' src='<?php echo esc_url(get_template_directory_uri() . "/images/js-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row pb-2">
                    <div class="col text-center">
            ...
            <div class="col-lg">
                <div class="row">
                    <div class="col text-center" id="other-tools-tech-image">
                        <img class='w-100' src='<?php echo esc_url(get_template_directory_uri() . "/images/jquery-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row pb-2">
                    <div class="col text-center">
            ...
            <div class="col-lg">
                <div class="row">
                    <div class="col text-center" id="other-tools-tech-image">
                        <img class='w-100' src='<?php echo esc_url(get_template_directory_uri() . "/images/github-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row pb-2">
                    <div class="col text-center">
            ...
            <div class="col-lg">
                <div class="row">
                    <div class="col text-center" id="other-tools-tech-image">
                        <img class='w-100' src='<?php echo esc_url(get_template_directory_uri() . "/images/xamp-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row pb-2">
                    <div class="col text-center">
            ...
            <div class="col-lg">
                <div class="row">
                    <div class="col text-center" id="other-tools-tech-image">
                        <img class='w-100' src='<?php echo esc_url(get_template_directory_uri() . "/images/pinterest-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row pb-2">
                    <div class="col text-center">
            ...
            <div class="col-lg">
                <div class="row">
                    <div class="col text-center" id="other-tools-tech-image">
                        <img class='w-100' src='<?php echo esc_url(get_template_directory_uri() . "/images/google-fonts-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row pb-2">
                    <div class="col text-center">
            ...
            <div class="col-md p-3">
                <div class="row">
                    <div class="col" id="why-choose-us-image">
                        <img class='w-25' src='<?php echo esc_url(get_template_directory_uri() . "/images/right-arrow-logo.png"); ?>' alt=''>
                    </div>
                </div>
                <div class="row">
