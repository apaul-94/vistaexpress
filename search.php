...
<body style="font-family: New Amsterdam, sans-serif;" <?php body_class(); ?>>
    ...
    $read_more_text = get_theme_mod('read_more_button_text', __('Read More', 'vistaexpress'));
    ...
    <div class="container">
        <div class="row row-cols-1">
            ...
            <div class="col-lg-8 p-3">
                <!-- Search Results -->
                <div class="content">
                    <h4 id="cat-tag-search-title"><?php printf(esc_html__('Search Results for: %s', 'vistaexpress'), esc_html($search_query)); ?></h4>
                    ...
                    <?php else : ?>
                        <p><?php _e('Sorry, no results found for your search.', 'vistaexpress'); ?></p>
                    <?php endif; ?>
